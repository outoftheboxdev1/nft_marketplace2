      ...
      <div className="w-full flexCenter flex-col">
        ...
        <div className="flexCenter flex-col -mt-20 z-0">
          <div className="flexCenter w-40 h-40 sm:w-36 sm:h-36 p-1 bg-nft-black-2 rounded-full relative">
            <Image src={`https://shedzx2emmqxeebf.public.blob.vercel-storage.com/${encodeURIComponent(currentAccount)}.png`} className="rounded-full object-cover" height={168} width={168} objectFit="cover" priority />
