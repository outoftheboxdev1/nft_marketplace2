...
const FooterLinks = ({ heading, items, extraClasses, urls }) => (
      ...
      <div className="w-full minmd:w-4/5 flex flex-row md:flex-col sm:px-4 px-16">
        <div className="flexStart flex-1 flex-col">
          <div className="flexCenter cursor-pointer">
            ...
            <p className=" dark:text-white text-nft-dark font-semibold text-lg ml-1">EverTraded</p>
          </div>
        ...
        <div className="flex-1 flexBetweenStart flex-wrap ml-10 md:ml-0 md:mt-8">
          ...
          <FooterLinks heading="Support" items={['Help Center', 'Terms of service', 'Legal', 'Privacy policy']} urls={['/faq', '/tos', '/', '/privacy-policy']} extraClasses="ml-4" />
        </div>
      </div>
